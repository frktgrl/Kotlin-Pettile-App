 ...
 * Use the [ProfileFamilyViewFragment.newInstance] factory method to
...
class ProfileFamilyViewFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProfileFamilyViewFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProfileFamilyViewFragment().apply {
