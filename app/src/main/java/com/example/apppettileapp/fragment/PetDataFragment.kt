...
import com.example.apppettileapp.databinding.FragmentPetDataBinding
...
class PetDataFragment : Fragment() {
    ...
    private lateinit var binding: FragmentPetDataBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPetDataBinding.inflate(layoutInflater)
        val view = binding.root

        auth = FirebaseAuth.getInstance()
        db = FirebaseFirestore.getInstance()

        binding.petDataRecyclerView.layoutManager = LinearLayoutManager(activity)
