...
import com.example.apppettileapp.databinding.ActivityAdoptionCreateBinding
        ...
        binding.shareButton.setOnClickListener {
            ...
            if(selectedPicture != null) {
                ...
                imageReference.putFile(selectedPicture!!).addOnSuccessListener {
                    ...
                    val uploadPictureReference = storage.reference.child("imagesAdoption").child(imageName)
