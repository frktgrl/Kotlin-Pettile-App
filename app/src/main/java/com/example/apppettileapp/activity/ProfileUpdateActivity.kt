...
class ProfileUpdateActivity : AppCompatActivity() {
    ...
    fun changePhotoClicked (view: View) {     if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_MEDIA_IMAGES) != PackageManager.PERMISSION_GRANTED ||
    ...
    private fun registerLauncher() {
        ...
        permissionLauncher = registerForActivityResult(
            ...
            if (result) {
                ...
                //permission denied
                Toast.makeText(this@ProfileUpdateActivity, "Permisson needed!", Toast.LENGTH_LONG).show()
            }
        }
    }
